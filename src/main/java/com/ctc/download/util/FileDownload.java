...
public class FileDownload {
	...
	/*
	 * public static void downloadWithApacheCommons(String url, String
	 * localFilename) {
	 * 
	 * int CONNECT_TIMEOUT = 10000; int READ_TIMEOUT = 10000; try {
	 * FileUtils.copyURLToFile(new URL(url), new File(localFilename),
	 * CONNECT_TIMEOUT, READ_TIMEOUT); } catch (IOException e) {
	 * e.printStackTrace(); }
	 * 
	 * }
	 */
